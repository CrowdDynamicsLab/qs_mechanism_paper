...
\aptLtoX[graphic=no,type=html]{%  ---------- HTML branch ----------
  \begin{quote}\small
    [T]he many, who are not as individuals excellent men, nevertheless can,
    ...
    better than feasts provided at one person's expense.%
    \hfill\texttt{-- Aristotle, \textit{Politics} III}%
  \end{quote}
}{%  ---------- PDF branch ----------
  \begin{displayquote}
    [T]he many, who are not as individuals excellent men, nevertheless can,
