...
\aptLtoX[graphic=no,type=html]{\begin{figure}[ht]
  \centering
    \includegraphics[width=0.45\textwidth]{content/image/cumulative_distribution_credit_usage.pdf}
    \caption[]{ Percentage of participants who fully utilized their credits across budget levels. As budgets increase, cumulative usage drops off more steeply.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.45\textwidth]{content/image/uqs_credit_usage_distribution_logbins.pdf}
